...
Every published package's `@public` exports are locked in `packages/<pkg>/etc/<entry>.api.md` snapshots generated by API Extractor. CI runs `bun run api:check` and fails on undocumented drift.
