...
For instructions specific to your checkout, create `local/AGENTS.md`. The root instructions tell agents to read this optional file before starting work. Git ignores the entire `local/` directory, so you can keep personal instructions and notes there.
