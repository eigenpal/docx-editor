...
export const UPDATE_TOC_PATHS: readonly string[] = [
  'M120-240v-80h240v80H120Zm0-200v-80h480v80H120Zm0-200v-80h720v80H120Z',
];

/** `format_list_numbered` — numbers beside rows, which is what this row updates. */
export const UPDATE_TOC_PAGE_NUMBERS_PATHS: readonly string[] = [
