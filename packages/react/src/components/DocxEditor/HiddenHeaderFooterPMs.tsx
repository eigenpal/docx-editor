...
export const HiddenHeaderFooterPMs = memo(
  forwardRef<HiddenHeaderFooterPMsRef, HiddenHeaderFooterPMsProps>(function HiddenHeaderFooterPMs(
    { document, styles, theme, defaultTabMarkTwips, onTransaction },
    ref
  ) {
    ...
    useEffect(() => {
      ...
      for (const slot of slots) {
        ...
        const state = buildInitialState(hf, styles, theme, defaultTabMarkTwips, mgr);
    ...
    }, [slots, resolveHf, styles, theme, defaultTabMarkTwips]);
