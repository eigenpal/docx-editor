// The toast host (`<Toaster>` from `sonner`) is the ONE piece of this component held
// back: `sonner` is not installed here and dependency installation is blocked in this
// repo, so importing it would break the build. Nothing else about the component changes,
// and restoring the toaster is a one-line edit once the dependency can be added.
