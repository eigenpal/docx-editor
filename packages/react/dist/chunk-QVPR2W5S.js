'use strict';
function n(e) {
  return { start: e, end: e, collapsed: true };
}
function r(e, t) {
  return {
    start: e,
    end: t,
    collapsed: e.paragraphIndex === t.paragraphIndex && e.offset === t.offset,
  };
}
function o(e, t) {
  return !(
    e.paragraphIndex < t.start.paragraphIndex ||
    (e.paragraphIndex === t.start.paragraphIndex && e.offset < t.start.offset) ||
    e.paragraphIndex > t.end.paragraphIndex ||
    (e.paragraphIndex === t.end.paragraphIndex && e.offset > t.end.offset)
  );
}
function i(e, t) {
  return e.paragraphIndex < t.paragraphIndex
    ? -1
...
var p = ['askAI', 'rewrite', 'expand', 'summarize', 'translate', 'explain'];
function g(e) {
  return { ...e, id: a() };
}
function a() {
