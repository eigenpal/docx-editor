...
export {
  ...
  k as ApplyVariablesCommand,
  l as BlockContent,
  C as Comment,
  m as CommentRangeEnd,
  n as CommentRangeStart,
  o as DEFAULT_AI_ACTIONS,
  ...
  a2 as TextContent,
  a3 as Theme,
  a4 as TrackedChangeInfo,
  a5 as TrackedRunChange,
  a6 as comparePositions,
  a7 as createCollapsedRange,
  a8 as createCommand,
  a9 as createRange,
  aa as getActionDescription,
  ab as getActionLabel,
  ac as isPositionInRange,
} from './agentApi-BVHzyk2l.js';
export {
  ...
  f as buildSelectionContextFromContext,
  g as colorsEqual,
  h as createDocumentWithText,
  i as createEmptyDocument,
  j as createRgbColor,
  k as createTemplateProcessor,
  ...
  v as getMissingVariables,
  w as getSelectionFormattingSummary,
  ...
  J as pixelsToTwips,
  K as pointsToPixels,
  L as previewTemplate,
  M as processTemplate,
  N as processTemplateAdvanced,
...
export {
  ...
  a as InsertImageOptions,
  b as InsertTableOptions,
  c as InsertTextOptions,
  d as attemptSelectiveSave,
  e as createAgent,
  f as createAgentFromDocument,
...
export {
  ...
  e as detectVariablesDetailed,
  f as detectVariablesInBody,
  g as detectVariablesInParagraph,
  h as documentHasVariables,
  i as extractVariablesFromText,
  j as formatVariable,
  k as hasTemplateVariables,
  l as isValidVariableName,
  p as parseVariable,
  r as removeVariables,
  m as repackDocx,
  n as replaceVariables,
  s as sanitizeVariableName,
  u as updateMultipleFiles,
  v as validatePatchSafety,
} from './variableDetector-CkYvLv62.js';
