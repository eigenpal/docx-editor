 ...
 */
declare function registerPlugins(
  plugins: CorePlugin[],
 ...
 */
declare function createPluginRegistrar(
  options: PluginOptions
): (plugin: CorePlugin) => PluginRegistrationResult;

export {
  PluginRegistry as P,
  createPluginRegistrar as c,
  pluginRegistry as p,
  registerPlugins as r,
};
