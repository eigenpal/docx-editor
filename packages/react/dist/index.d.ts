import { R as ReactEditorPlugin } from './react-By80Gfi-.js';
export {
  D as DEFAULT_SELECTION_STYLE,
  a as DocxEditor,
  b as DocxEditorHandle,
  c as DocxEditorProps,
  d as DocxEditorRef,
  E as EditorMode,
  e as EditorPlugin,
  f as ErrorBoundary,
  g as ErrorBoundaryProps,
  h as ErrorContextValue,
  i as ErrorProvider,
  H as HIGH_CONTRAST_SELECTION_STYLE,
  j as HighlightRect,
  P as PLUGIN_HOST_STYLES,
  k as ParseErrorDisplay,
  l as ParseErrorDisplayProps,
  m as PluginContext,
  n as PluginHost,
  o as PluginHostProps,
  p as PluginHostRef,
  q as RenderAsyncOptions,
  S as SELECTION_CSS_VARS,
  r as SelectionHighlightConfig,
  s as SelectionOverlayProps,
  t as SelectionRange,
  T as TableSelectionState,
  U as UnsupportedFeatureWarning,
  u as UnsupportedFeatureWarningProps,
  v as UseAutoSaveOptions,
  w as UseAutoSaveReturn,
  x as UseClipboardOptions,
  y as UseClipboardReturn,
  z as UseSelectionHighlightOptions,
  A as UseSelectionHighlightReturn,
  B as UseTableSelectionOptions,
  C as UseTableSelectionReturn,
  F as UseWheelZoomOptions,
  G as UseWheelZoomReturn,
  Z as ZOOM_PRESETS,
  I as areSelectionStylesInjected,
  J as clampZoom,
  K as clearSelection,
  L as createSelectionChangeHandler,
  M as findNearestZoomPreset,
  N as formatZoom,
  O as generateOverlayElements,
  Q as generateSelectionCSS,
  V as getHighlightRectStyle,
  W as getMergedSelectionRects,
  X as getNextZoomPreset,
  Y as getPreviousZoomPreset,
  _ as getSelectedText,
  $ as getSelectionBoundingRect,
  a0 as getSelectionRects,
  a1 as getUserFriendlyMessage,
  a2 as getZoomPresets,
  a3 as hasActiveSelection,
  a4 as highlightTextRange,
  a5 as injectSelectionStyles,
  a6 as isParseError,
  a7 as isSelectionBackwards,
  a8 as isSelectionWithin,
  a9 as isZoomPreset,
  aa as mergeAdjacentRects,
  ab as normalizeSelectionDirection,
  ac as parseZoom,
  ad as removeSelectionStyles,
  ae as renderAsync,
  af as selectRange,
  ag as useAutoSave,
  ah as useClipboard,
  ai as useErrorNotifications,
...
export {
  ...
  g as DocxInput,
  t as toArrayBuffer,
} from './DocumentAgent-CRCXiBT7.js';
export {
  ...
  _ as twipsToPixels,
  $ as validateTemplate,
} from './colorResolver-Dlmk3itT.js';
export {
  I as InsertPosition,
  c as canRenderFont,
...
export {
  C as CLIPBOARD_TYPES,
  a as ClipboardContent,
  b as ClipboardOptions,
  I as INTERNAL_CLIPBOARD_TYPE,
  P as ParsedClipboardContent,
  c as PrintButton,
  d as PrintButtonProps,
  e as PrintOptions,
  f as PrintStyles,
  T as TableAction,
  g as TableContext,
  h as TableSelection,
  i as TableToolbar,
  j as TableToolbarProps,
  k as addColumn,
  l as addRow,
  m as cleanWordHtml,
  n as copyParagraphs,
  o as copyRuns,
  p as createClipboardHandlers,
  q as createTableContext,
  r as deleteColumn,
  s as deleteRow,
  t as formatPrintPageRange,
  u as getCellAt,
  v as getColumnCount,
  w as getDefaultPrintOptions,
  x as handlePasteEvent,
  y as htmlToRuns,
  z as isEditorHtml,
  A as isPrintSupported,
  B as isWordHtml,
  D as mergeCells,
  E as openPrintWindow,
  F as paragraphsToClipboardContent,
  G as parseClipboardHtml,
  H as parsePageRange,
  J as readFromClipboard,
  K as runsToClipboardContent,
  L as splitCell,
  M as triggerPrint,
  N as writeToClipboard,
} from './clipboard-B7N7Kx2X.js';
export {
  f as AIAction,
  ...
  E as Endnote,
  af as Field,
  ag as FooterReference,
  F as Footnote,
  t as FormatTextCommand,
  ah as HeaderFooter,
  ai as HeaderReference,
  H as Hyperlink,
  I as Image,
  u as InsertHyperlinkCommand,
  v as InsertImageCommand,
  w as InsertTableCommand,
  x as InsertTextCommand,
  L as ListLevel,
  N as NumberingDefinitions,
  a as Paragraph,
  J as ParagraphContext,
  K as ParagraphFormatting,
  P as Position,
  R as Range,
  Q as Relationship,
  S as ReplaceTextCommand,
  b as Run,
  c as RunContent,
  V as SectionProperties,
  W as SelectionContext,
  X as SetVariableCommand,
  aj as Shape,
  Y as Style,
  Z as StyleDefinitions,
  $ as SuggestedAction,
  e as Table,
  a0 as TableCell,
  a1 as TableRow,
  ...
  T as TextFormatting,
  a3 as Theme,
  al as ThemeColorScheme,
  am as ThemeFont,
  an as ThemeFontScheme,
} from './agentApi-BVHzyk2l.js';
...
export {
  ...
  i as McpToolHandler,
  j as McpToolResult,
} from './types-igZ1x_e4.js';
export {
  P as PluginRegistry,
  p as pluginRegistry,
  r as registerPlugins,
} from './registry-CgWNVTk9.js';
export { docxtemplaterPlugin } from './core-plugins-reexport.js';
import { k as PluginPanelProps } from './ClipboardManager-D0D4aUKE.js';
export {
  d as AutoSaveStatus,
...
} from './ClipboardManager-D0D4aUKE.js';
...
declare function DocumentName({
  value,
  onChange,
  placeholder,
  editable,
}: DocumentNameProps): react_jsx_runtime.JSX.Element;
 ...
 */
declare function findVisualLineStart(
  container: Node,
  offset: number
): {
  node: Node;
 ...
 * Uses visual line detection based on bounding rectangles
 */
declare function findVisualLineEnd(
  container: Node,
  offset: number
): {
  node: Node;
 ...
 */
declare function handleNavigationKey(
  event: KeyboardEvent,
  options?: {
...
declare function AnnotationPanel({
  editorView,
  pluginState,
  renderedDomContext,
}: AnnotationPanelProps): react_jsx_runtime.JSX.Element | null;
...
export {
  ...
  isNavigationKey,
  isPunctuation,
  isWhitespace$1 as isWhitespace,
  isWhitespace as isWhitespaceChar,
  isWordCharacter as isWordChar,
  isWordCharacter$1 as isWordCharacter,
  matchesShortcut,
  moveByWord,
  moveToLineEdge,
