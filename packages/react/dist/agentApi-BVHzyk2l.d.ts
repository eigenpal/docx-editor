...
export {
  ...
  type Endnote as E,
  type Footnote as F,
  type ParagraphContent as G,
  type Hyperlink as H,
  type Image as I,
  type ParagraphContext as J,
  type ParagraphFormatting as K,
  type ListLevel as L,
  type MoveFrom as M,
  type NumberingDefinitions as N,
  type ParagraphOutline as O,
  type Position as P,
  type Relationship as Q,
  type Range as R,
  type ReplaceTextCommand as S,
  type TextFormatting as T,
  type SectionInfo as U,
  type SectionProperties as V,
  type SelectionContext as W,
  type SetVariableCommand as X,
  type Style as Y,
  type StyleDefinitions as Z,
  type StyleInfo as _,
  type Paragraph as a,
  type TableCell as a0,
  type TableRow as a1,
  type TextContent as a2,
  type Theme as a3,
  type TrackedChangeInfo as a4,
  type TrackedRunChange as a5,
  comparePositions as a6,
  createCollapsedRange as a7,
  createCommand as a8,
  createRange as a9,
  getActionDescription as aa,
  getActionLabel as ab,
  isPositionInRange as ac,
  type BookmarkEnd as ad,
  type BookmarkStart as ae,
  type Field as af,
  type FooterReference as ag,
  type HeaderFooter as ah,
  type HeaderReference as ai,
  type Shape as aj,
  type TextBox as ak,
  type ThemeColorScheme as al,
  type ThemeFont as am,
  type ThemeFontScheme as an,
  type ColorValue as ao,
  type ThemeColorSlot as ap,
  type ParagraphAlignment as aq,
  type StyleType as ar,
  type TabStop as as,
  type Run as b,
  ...
  type CommentRangeEnd as m,
  type CommentRangeStart as n,
  DEFAULT_AI_ACTIONS as o,
  type DeleteTextCommand as p,
  type Deletion as q,
  type DocxPackage as r,
  type FormatParagraphCommand as s,
  type FormatTextCommand as t,
  type InsertHyperlinkCommand as u,
  type InsertImageCommand as v,
  type InsertTableCommand as w,
  type InsertTextCommand as x,
  type Insertion as y,
  type MoveTo as z,
};
