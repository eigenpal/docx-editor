...
export {
  getSelectionBoundingRect as $,
  type UseSelectionHighlightReturn as A,
  type UseTableSelectionOptions as B,
  type UseTableSelectionReturn as C,
  DEFAULT_SELECTION_STYLE as D,
  type EditorMode as E,
  type UseWheelZoomOptions as F,
  type UseWheelZoomReturn as G,
  HIGH_CONTRAST_SELECTION_STYLE as H,
  areSelectionStylesInjected as I,
  clampZoom as J,
  clearSelection as K,
  createSelectionChangeHandler as L,
  findNearestZoomPreset as M,
  formatZoom as N,
  generateOverlayElements as O,
  PLUGIN_HOST_STYLES as P,
  generateSelectionCSS as Q,
  type ReactEditorPlugin as R,
  SELECTION_CSS_VARS as S,
  type TableSelectionState as T,
  UnsupportedFeatureWarning as U,
  getHighlightRectStyle as V,
  getMergedSelectionRects as W,
  getNextZoomPreset as X,
  getPreviousZoomPreset as Y,
  ZOOM_PRESETS as Z,
  getSelectedText as _,
  DocxEditor as a,
  getSelectionRects as a0,
  getUserFriendlyMessage as a1,
  getZoomPresets as a2,
  hasActiveSelection as a3,
  highlightTextRange as a4,
  injectSelectionStyles as a5,
  isParseError as a6,
  isSelectionBackwards as a7,
  isSelectionWithin as a8,
  isZoomPreset as a9,
  mergeAdjacentRects as aa,
  normalizeSelectionDirection as ab,
  parseZoom as ac,
  removeSelectionStyles as ad,
  renderAsync as ae,
  selectRange as af,
  useAutoSave as ag,
  useClipboard as ah,
  useErrorNotifications as ai,
  useSelectionHighlight as aj,
  useTableSelection as ak,
  useWheelZoom as al,
  ...
  ErrorBoundary as f,
  type ErrorBoundaryProps as g,
  type ErrorContextValue as h,
  ErrorProvider as i,
  type HighlightRect as j,
  ParseErrorDisplay as k,
  type ParseErrorDisplayProps as l,
  type PluginContext as m,
  PluginHost as n,
  type PluginHostProps as o,
  type PluginHostRef as p,
  type RenderAsyncOptions as q,
  type SelectionHighlightConfig as r,
  type SelectionOverlayProps as s,
  type SelectionRange as t,
  type UnsupportedFeatureWarningProps as u,
  type UseAutoSaveOptions as v,
  type UseAutoSaveReturn as w,
  type UseClipboardOptions as x,
  type UseClipboardReturn as y,
  type UseSelectionHighlightOptions as z,
};
