...
and a chat UI for React and Vue. It is now one thing: a batching object model that drives a
...
| Before                                  | After                                                       |
| --------------------------------------- | ----------------------------------------------------------- |
| `@docx-editor.dev/agents`               | `@docx-editor.dev/agents` — server/worker, from DOCX bytes   |
| `@docx-editor.dev/agents/server`        | `@docx-editor.dev/agents`                                   |
| `@docx-editor.dev/agents/bridge`        | `@docx-editor.dev/agents/browser`                            |
| `@docx-editor.dev/agents/react`         | `@docx-editor.dev/agents/browser` — no React-specific entry  |
| `@docx-editor.dev/agents/vue`           | `@docx-editor.dev/agents/browser` — no Vue-specific entry    |
