...
export default defineConfig({
  ...
  entry: {
    ...
    'contracts/plugin': 'src/contracts/plugin.ts',
  ...
  esbuildOptions(options) {
    options.alias = {
      ...
      '@docx-editor.dev/core/contracts/mcp': resolve(here, 'src/contracts/mcp.ts'),
      '@docx-editor.dev/core/contracts/modules': resolve(here, 'src/contracts/modules.ts'),
      '@docx-editor.dev/core/contracts/plugin': resolve(here, 'src/contracts/plugin.ts'),
