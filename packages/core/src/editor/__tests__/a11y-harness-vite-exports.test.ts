...
} from '../../../../engine-editor/scripts/a11y-harness-vite-policy.ts';

// The browser harness — vite config, scripts, the e2e app — is NOT lane source and stayed
// in `packages/engine-editor` when the editor lane moved. This points at the harness, not
// at the lane.
const packageRoot = join(dirname(fileURLToPath(import.meta.url)), '..', '..', '..', '..', 'engine-editor');
