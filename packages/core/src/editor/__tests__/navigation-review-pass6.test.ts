...
import { caretOverlayForTarget, deriveCaretGeometry } from '../interaction-geometry.ts';
import { planKeyboardNavigation } from '../keyboard-navigation.ts';
import { caretContentX, pageRelativeY } from '../line-catalog.ts';
import { hasGeometryStopAtOffset, isHorizontalTransitionOffset } from '../navigation-stops.ts';
