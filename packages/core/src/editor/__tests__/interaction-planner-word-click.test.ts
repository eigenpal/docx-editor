...
import { planInteraction, type InteractionPlannerContext } from '../interaction-planner.ts';
import { hitTestPointer } from '../interaction-geometry.ts';
import { endpointsOnGraphemeBoundaries, wordSelectionFromHit } from '../word-selection.ts';
