export {
  ...
  S as ContextSelectionOptions,
  C as CreateEmptyDocumentOptions,
  D as DocumentAgent,
  E as ExtendedSelectionContext,
  F as FormattedTextSegment,
  a as FormattingSummary,
  I as InsertHyperlinkOptions,
  b as InsertImageOptions,
  c as InsertTableOptions,
  d as InsertTextOptions,
  ...
  h as attemptSelectiveSave,
  i as blendColors,
  j as buildExtendedSelectionContext,
  k as buildPatchedDocumentXml,
  l as buildSelectionContext,
  m as buildSelectionContextFromContext,
  n as colorsEqual,
  o as createAgent,
  p as createAgentFromDocument,
  q as createDocumentWithText,
  r as createDocx,
  s as createEmptyDocument,
  t as createRgbColor,
  u as createTemplateProcessor,
  v as createThemeColor,
  w as darkenColor,
  x as detectVariables,
  y as detectVariablesDetailed,
  z as detectVariablesInBody,
  B as detectVariablesInParagraph,
  G as documentHasVariables,
  H as emuToPixels,
  J as emuToTwips,
  K as executeCommand,
  L as executeCommands,
  M as extractVariablesFromText,
  N as formatPx,
  O as formatVariable,
  Q as getAgentContext,
  R as getContrastingColor,
  U as getDocumentSummary,
  W as getMissingVariables,
  X as getSelectionFormattingSummary,
  Y as getTemplateTags,
  Z as halfPointsToPixels,
  _ as hasTemplateVariables,
  $ as isBlack,
  a0 as isValidVariableName,
  a1 as isWhite,
  a2 as lightenColor,
  a3 as parseColorString,
  a4 as parseDocx,
  a5 as parseVariable,
  a6 as pixelsToEmu,
  a7 as pixelsToTwips,
  a8 as pointsToPixels,
  a9 as previewTemplate,
  aa as processTemplate,
  ab as processTemplateAdvanced,
  ac as processTemplateAsBlob,
  ad as processTemplateDetailed,
  ae as removeVariables,
  af as repackDocx,
  ag as replaceVariables,
  ah as resolveColor,
  ai as resolveHighlightColor,
  aj as resolveShadingColor,
  ak as sanitizeVariableName,
  al as serializeDocumentBody,
  am as serializeDocx,
  an as serializeSectionProperties,
  ao as twipsToEmu,
  ap as twipsToPixels,
  aq as updateMultipleFiles,
  ar as validatePatchSafety,
  as as validateTemplate,
} from './variableDetector-BhjJrIRk.js';
import {
  D as DocumentBody,
  d as Paragraph,
  T as TextFormatting,
...
export {
  ...
  l as ApplyVariablesCommand,
  B as BlockContent,
  b as CommandHandler,
  m as CommandResult,
  n as Comment,
  o as CommentRangeEnd,
  p as CommentRangeStart,
  C as CorePlugin,
  q as DEFAULT_AI_ACTIONS,
  ...
  E as Endnote,
  F as Footnote,
  v as FormatParagraphCommand,
  w as FormatTextCommand,
  I as Image,
  x as InsertHyperlinkCommand,
  y as InsertImageCommand,
  z as InsertTableCommand,
  ...
  X as MoveFrom,
  Y as MoveTo,
  Z as NumberingDefinitions,
  _ as ParagraphContent,
  $ as ParagraphContext,
  a0 as ParagraphFormatting,
  a1 as ParagraphOutline,
  C as Plugin,
  a2 as PluginCommand,
  ...
  a4 as Range,
  a5 as Relationship,
  a6 as ReplaceTextCommand,
  a7 as RunContent,
  a8 as SectionInfo,
  a9 as SectionProperties,
  aa as SelectionContext,
  ab as SetVariableCommand,
  ac as Style,
  ad as StyleDefinitions,
  ae as StyleInfo,
  af as SuggestedAction,
  ag as TableCell,
  ah as TableRow,
  ai as TextContent,
  aj as Theme,
  ...
  V as ToolHandler,
  W as ToolResult,
  ak as TrackedChangeInfo,
  al as TrackedRunChange,
  am as ZodSchemaLike,
  an as comparePositions,
  ao as createCollapsedRange,
  ap as createCommand,
  aq as createRange,
  ar as getActionDescription,
  as as getActionLabel,
  at as isPositionInRange,
  au as isZodSchema,
} from './types-BhDofcWh.js';
export {
  P as PluginRegistry,
 ...
 */
declare function getTextBefore(
 ...
 */
declare function getFormattingAtPosition(
  paragraph: Paragraph,
  offset: number
 ...
 */
declare function getHyperlinkAtPosition(
  paragraph: Paragraph,
  offset: number
): Hyperlink | undefined;
/**
