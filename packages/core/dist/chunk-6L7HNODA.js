'use strict';
var chunk65V65RRX_js = require('./chunk-65V65RRX.js'),
  I = require('jszip');
...
function b(e) {
  ...
  if (
    ...
    if (le.has(e.highlight)) t.push(`<w:highlight w:val="${e.highlight}"/>`);
    else if (!e.shading) {
...
function y(e) {
  let t = [],
    n = he(e.formatting, e.propertyChanges);
  n && t.push(n);
...
function W(e, t) {
  ...
  return (
    t && t.length > 0 && n.push(...t.map((r) => Le(r))),
...
function q(e, t) {
  ...
  return (
    t && t.length > 0 && n.push(...t.map((r) => Ue(r))),
...
function J(e, t, n) {
  ...
  return (
    ...
    t && t.length > 0 && r.push(...t.map((i) => Ke(i))),
...
function ut(e) {
  ...
  if (t.bottom) {
    let o = z(t.bottom, 'bottom');
    o && r.push(o);
  }
  if (t.right) {
    let o = z(t.right, 'right');
    o && r.push(o);
  }
  return r.length === 0
    ? ''
...
function ht(e) {
  if (!e) return '';
  let t = [];
  if (e.headerReferences) for (let f of e.headerReferences) t.push(it(f));
  if (e.footerReferences) for (let f of e.footerReferences) t.push(ot(f));
...
function wt(e) {
  ...
  return (
    t.push(dt(e.content)),
    e.finalSectionProperties && t.push(ht(e.finalSectionProperties)),
    t.join('')
  );
}
function Q(e) {
...
function te(e) {
  ...
  if (e.content && e.content.length > 0) {
    n += Tt(e.content[0]);
    for (let r = 1; r < e.content.length; r++) n += $t(e.content[r]);
  } else
    n +=
...
async function Pt(e, t, n) {
  ...
  (t.file('word/comments.xml', i, { compression: 'DEFLATE', compressionOptions: { level: n } }),
    await Promise.all([At(t, n), zt(t, n)]));
}
function ie(e) {
  let t = [];
  for (let n of e)
...
function vt(e) {
  ...
  return { data: r.buffer, extension: bt[t[1]] || 'png' };
}
async function Ct(e, t, n) {
  ...
  let l = [],
    p = new Set();
  for (let f of e) {
    let { data: m, extension: u } = vt(f.src);
    (a++, c++);
    let h = `image${a}.${u}`,
      g = `word/media/${h}`,
      F = `rId${c}`;
...
async function Ft(e, t, n) {
  ...
  for (let l of e) {
    ...
    let p = `rId${c}`;
    (a.push(
      `<Relationship Id="${p}" Type="${chunk65V65RRX_js.a.hyperlink}" Target="${s(l.href)}" TargetMode="External"/>`
    ),
      (l.rId = p));
  }
  a.length > 0 &&
...
async function St(e, t = {}) {
  ...
  let { compressionLevel: n = 6, updateModifiedDate: r = true, modifiedBy: i } = t,
    o = e,
    c = await I__default.default.loadAsync(e.originalBuffer),
    a = new I__default.default();
  ...
  if (
    ...
    if (h) {
      let g = await h.async('text'),
        F = Bt(g, { updateModifiedDate: r, modifiedBy: i });
...
var Rt = 'application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml';
async function At(e, t) {
  ...
  r.includes('/word/comments.xml') ||
    ((r = r.replace(
      '</Types>',
      `<Override PartName="/word/comments.xml" ContentType="${Rt}"/></Types>`
    )),
...
async function zt(e, t) {
  ...
  ((i = i.replace(
    '</Relationships>',
    `<Relationship Id="${o}" Type="${chunk65V65RRX_js.a.comments}" Target="comments.xml"/></Relationships>`
  )),
    e.file(n, i, { compression: 'DEFLATE', compressionOptions: { level: t } }));
}
async function ln(e, t, n = {}) {
  let r = await I__default.default.loadAsync(e);
  return It(r, t, n);
}
...
function Dt(e) {
  ...
  if (!n) return t;
  let r = [
    { map: e.package.headers, type: chunk65V65RRX_js.a.header },
    { map: e.package.footers, type: chunk65V65RRX_js.a.footer },
  ];
...
function kt(e, t, n) {
  let r = { level: n };
  for (let [i, o] of Dt(e)) t.file(i, o, { compression: 'DEFLATE', compressionOptions: r });
}
function Bt(e, t) {
  let n = e;
...
exports.j = Dt;
exports.k = Bt;
exports.l = pn; //# sourceMappingURL=chunk-6L7HNODA.js.map
//# sourceMappingURL=chunk-6L7HNODA.js.map
