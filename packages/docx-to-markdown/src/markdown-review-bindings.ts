...
/** Lossless link from a Core review occurrence to generated Markdown offsets. @public */
export interface MarkdownReviewBinding {
  /** ID of the corresponding entry in `MarkdownExportResult.reviewArtifacts`. */
  readonly artifactId: string;
  /** Discriminant of the corresponding review artifact. */
  readonly artifactKind: MarkdownReviewArtifact['kind'];
  /** Index into the artifact's immutable `occurrences` array. */
