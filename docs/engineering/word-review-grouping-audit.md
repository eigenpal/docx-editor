...
- The standalone grid history and the orphan range around a move wrapper account for the two fixture counts still outside the verified count assertions.
