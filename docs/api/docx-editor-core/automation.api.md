...
// @public
export const AUTOMATION_SOLITARY_OPERATIONS: readonly ["insertTable", "insertInlinePicture", "insertBreak", "startNewList", "setListLevelFormat", "deleteNote", "insertComment", "setCommentResolved", "replyToComment", "insertCustomNode"];
