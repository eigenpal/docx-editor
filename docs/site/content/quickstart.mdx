...
Either adapter pulls in `@docx-editor.dev/core` and `@docx-editor.dev/i18n` transitively. One install is enough.
...
- [DocxEditor API](/docs/1.x/editor-api) to wire AI tools to the editor
