...
Pulls in `@docx-editor.dev/core-contract` and `@docx-editor.dev/i18n`. Add `@docx-editor.dev/editor-api` if you want to automate the document from code.
...
The review module and pane are licensed PRO surfaces from `@docx-editor.dev/pro` and `@docx-editor.dev/pro/react`; they are not exports of the React adapter.
