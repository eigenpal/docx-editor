...
Connect your own buttons with command hooks. Change their appearance and visibility while reading editor state with `useEditorState`. The engine supplies enabled state and refusal reasons.
