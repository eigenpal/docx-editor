...
Use command hooks to connect custom buttons. Read selected state with `useEditorState`. Switch editing modes to inspect command availability and refusal reasons.
