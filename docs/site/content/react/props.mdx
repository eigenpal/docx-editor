...
Render callbacks also work. Use `false` only when you own the trigger and visibility.
For supported surfaces and defaults, see [Customize popups](/docs/2.x/guides/customize-dialogs).
