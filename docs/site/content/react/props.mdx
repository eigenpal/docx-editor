...
| ---------- | ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `document` | `DocumentSource`                                                 | DOCX bytes, `'blank'` for an empty document, or an existing `DocumentHandle`.                                                                      |
...
Tracked changes are colored per author by default. To override an author's color or opt out, mount the declarative `<DocxEditor.AuthorStyle />` and `<DocxEditor.ColorByChangeType />` components as children — there is no prop for it. See [Tracked changes](/docs/2.x/pro/tracked-changes).
