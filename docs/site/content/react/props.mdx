...
Configure automatic overlays with typed renderer callbacks or `false` for manual
ownership. Entries cover dialogs, hyperlinks, images, notes, content controls,
equations, validation messages, and context menus. Explicit entries override legacy popup shortcuts. For callback props
