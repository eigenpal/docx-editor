...
Render this component as a descendant of `DocxEditor.Root`:
...
The [`examples/vue` application](https://github.com/eigenpal/docx-editor/tree/main/examples/vue) shows composition chrome, menu overrides, rulers, navigation, and package build mode. Run it with `bun run dev:vue`.
