...
```ts
import { McpServer } from '@docx-editor.dev/agents/mcp';
import { createReviewerBridge } from '@docx-editor.dev/agents';
...
| Subpath                        | Use when                                                                                  |
| ------------------------------ | ----------------------------------------------------------------------------------------- |
| `@docx-editor.dev/agents` | `DocxReviewer`, `agentTools`, `getToolSchemas`, `executeToolCall`, `createReviewerBridge` |
