...
<Cards>
  ...
  <Card title="Igloo" href="https://igloo.docx-editor.dev/">
    Build a themed editor. Host markup and hooks replace the packaged controls, and an expedition
    permit shows every content control with a pop-up of the demo's own. This card opens the deployed
    demo. Its source is in `examples/igloo`.
  </Card>
  <Card
    title="Custom nodes"
