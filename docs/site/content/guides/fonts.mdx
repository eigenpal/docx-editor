...
1. A direct catalog match, or a redirect you passed in `substitute`.
2. A built-in metric-compatible redirect, such as Calibri to Carlito.
3. A packaged face for a family the catalog cannot match. Century Gothic is the
