...
Place `<UseDepartureDate />` inside the date arrangement above. In Vue, import the composable from `@docx-editor.dev/vue`; reactive state uses refs, which templates unwrap automatically.
