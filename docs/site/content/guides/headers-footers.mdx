...
To stamp a watermark on a server, drive the document through [`@docx-editor.dev/editor-api`](/docs/2.x/editor-api). The editor's own watermark chrome is the interactive path.
