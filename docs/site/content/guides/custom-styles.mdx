...
These styles demonstrate the composition API; they are not packaged toolbar presets. The demo shows selected controls and styles. Use your own components and CSS to build other editor interfaces.
