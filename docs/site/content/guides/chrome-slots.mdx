...
## Alignment, direction, lists, and formatting
...
Alignment slots name a physical edge. In a right-to-left paragraph, `alignment.right` writes the leading edge, which Word spells `w:jc="left"`. The direction slots set the base direction of each selected paragraph and show a mixed selection as neither pressed.
...
| `direction.ltr`     | Default toolbar  | `LeftToRight`            | Left-to-right paragraph   |
| `direction.rtl`     | Default toolbar  | `RightToLeft`            | Right-to-left paragraph   |
