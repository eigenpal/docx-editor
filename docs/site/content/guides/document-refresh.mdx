...
For a complete React app and mock server, see [Build a document refresh app](/docs/2.x/guides/document-refresh-example). The editor does not watch a file path or URL. Your application receives updates and calls `refresh.apply()`.
