...
Choose an **Example**, then select **Run preview**. Each example shows one behavior and its API source. Expand **Source code** to inspect the calls. Select **Replay** to run the example again.
