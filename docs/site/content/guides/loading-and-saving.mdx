...
description: 'Load DOCX bytes into the current root component, swap documents through the shared ref, and save them back out on demand.'
category: 'Guides'
...
- [Props reference](/docs/1.x/react/props) for `document`, `onSave`, and the shared ref
