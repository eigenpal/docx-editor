...
Use the refresh controller to accept updated DOCX bytes and preserve scroll. For more information, see [Refresh from server updates](/docs/2.x/guides/document-refresh).
