...
its whole result removes it. Typing at the end boundary inserts ordinary text
after the field, including at the end of a paragraph. Word-delete shortcuts remove
the complete field from its boundary. Backspace and Shift+Backspace first select
the field, then remove it on the next press. In a document protected for forms, editing keeps
