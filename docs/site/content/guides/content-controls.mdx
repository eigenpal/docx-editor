...
for dropdown, combo box, and date entry. Omitted entries retain the engine's own
menus. A configured `contentControlWidget` renders
...
that entry the engine toggles the box itself. See
