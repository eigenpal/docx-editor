...
```ts
import { setContentControlContent, removeContentControl } from "@docx-editor.dev/core/headless";
...
```ts
import { setContentControlValue } from "@docx-editor.dev/core/headless";
...
```ts
import { createContentControl } from "@docx-editor.dev/core/headless";
...
```ts
import { addRepeatingSectionItem, removeRepeatingSectionItem } from "@docx-editor.dev/core/headless";
...
- [DocxEditor API](/docs/1.x/editor-api) for filling documents from an LLM
