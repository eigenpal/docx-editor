...
Try the full toolbar, compact toolbar, and custom command bar. Select document text, then apply formatting with each design. The source panel shows the public APIs for the selected design.
