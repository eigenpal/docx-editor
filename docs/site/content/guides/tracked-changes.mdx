...
It returns `false` when the paragraph or search text is not found. This is the primitive automated redlining builds on; see [Automation](/docs/1.x/agents) for driving it from code.
...
- [Automation](/docs/1.x/agents) for proposing tracked changes from code
