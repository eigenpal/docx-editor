...
A footnote area can use the space below the text of the last body line on its page. This applies when that line uses `auto` or `atLeast` line spacing. A line that carries a footnote reference keeps its full line height above the notes.
