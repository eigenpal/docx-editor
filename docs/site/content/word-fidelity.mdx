...
When the theme leaves its East Asian face empty, the run's inherited `w:lang/@w:eastAsia`
selects the theme's language-specific face. Chinese, Japanese, and Korean use named
