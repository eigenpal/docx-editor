...
Rows with bottom-to-top cell text use the text length when they have no fixed height. Minimum row heights also control text alignment. If another cell makes the row taller, alignment still uses the measured height.
