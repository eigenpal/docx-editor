...
Manual page breaks (`w:br w:type="page"`) inside table cells do not add lines or start pages. The document retains these breaks for editing and saving. Manual line breaks still start a new line inside a cell.
