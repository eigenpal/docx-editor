...
| Drawing shapes | Renders solid rectangles, ellipses, lines, bounded polygons, and groups, with outlines drawn at full width. Other shapes use a placeholder. | No | Preserved |
