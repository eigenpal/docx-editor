...
HTML copy preserves right-to-left table columns without changing cell text direction. Nested tables keep their own direction. HTML paste reads explicit table direction and maps physical borders and margins back to the document grid.
