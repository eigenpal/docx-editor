---
title: 'Headless API'
description: 'Reference for @docx-editor.dev/core/headless: DOCX parse and serialize, document creation, content controls, templates, watermarks, DocumentAgent.'
category: 'Core'
---
...
```ts
import { parseDocx, repackDocx } from '@docx-editor.dev/core/headless';
...
```ts
import { getParagraphs, getParagraphText } from '@docx-editor.dev/core/headless';
...
- Plugin system: `pluginRegistry`, `registerPlugins`, and `createPluginRegistrar`.
