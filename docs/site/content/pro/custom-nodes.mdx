...
| `preserveOnExport` | Result                                                                     |
| ------------------ | -------------------------------------------------------------------------- |
| `true` (default)   | Unchanged. Tag, binding and payload all travel.                            |
| `'text'`           | The control is unwrapped. The text remains; the tag, binding and payload go. |
| `false`            | The node is removed with its content.                                      |
