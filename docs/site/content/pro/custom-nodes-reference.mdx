...
The API surface of [custom nodes](/docs/2.x/pro/custom-nodes). Start with the guide if you have not built one yet.
...
List every definition whose nodes might be in the document. **A definition you do not pass is not touched**, and an unmatched node remains unchanged.
