...
`reviewDisplayMode` is `'simple-markup'`, `'all-markup'`, `'proposed'` (No
Markup), or `'original'`. A click on a change bar changes it too. Vue offers the
same pair of composables.
