...
Use the dedicated [collaboration format version](/docs/2.x/pro/collaboration-versions)
...
and follow [collaboration upgrades](/docs/2.x/pro/collaboration-versions).
...
[upgrade guide](/docs/2.x/pro/collaboration-versions); refreshing credentials
...
See [Collaboration versions and upgrades](/docs/2.x/pro/collaboration-versions)
...
Follow [Upgrade saved rooms](/docs/2.x/pro/collaboration-versions#upgrade-saved-rooms)
...
[saved-room upgrade procedure](/docs/2.x/pro/collaboration-versions#upgrade-saved-rooms). A fresh `Y.Doc` joining the same
