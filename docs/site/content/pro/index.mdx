...
description: 'Add tracked changes, comments, collaboration, and custom nodes to React or Vue through editor modules.'
category: 'Pro'
order: 60
---
...
`@docx-editor.dev/pro` adds these capabilities to the Vue and React editors:
...
`reviewModule`, `customNodesModule`, and `collaborationModule` accept an optional `licenseKey`.
