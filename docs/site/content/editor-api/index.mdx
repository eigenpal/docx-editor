...
See [Build a DOCX agent](/docs/2.x/build-a-docx-agent) for a walkthrough, or the [server agent guide](https://github.com/eigenpal/docx-editor/blob/main/packages/editor-api/OFFICE_JS_GUIDE.md) for tracked edits and recovery.
