...
| Lists                        | Partial          | Create lists, attach/detach paragraphs, set bullets/numbering, nesting, indents, and restart                                  | Picture bullets are unavailable. Different list levels need separate syncs.                                                                      |
...
Different levels of one list need separate syncs.
