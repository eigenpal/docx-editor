...
Structural edits can fail on merged grids, protected content, nested preserved structures, and pending revisions.
...
The runtime rejects table creation, structural edits, and formatting while tracking changes.
