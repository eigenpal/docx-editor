...
Unsupported formats and invalid payloads refuse; changing the filename does not convert an image.
...
Contradictory width and height assignments under the lock refuse.
...
Protected, unsupported, or revision-bearing targets can refuse mutation.
Runtime-local tracking does not support image insertion, removal, or formatting.
