...
description: 'The Office.js-compatible subset: what of the Word JavaScript object model is implemented, how the shape is verified, and what it omits.'
category: 'Editor API'
order: 53
---
...
- **A subset**, and the omissions below are the interesting part.
