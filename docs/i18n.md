...
For ordering/ranking, use `selectordinal`:
...
```tsx
t('birthday', { year: 1 }); // → "It's your 1st birthday!"
t('birthday', { year: 2 }); // → "It's your 2nd birthday!"
t('birthday', { year: 3 }); // → "It's your 3rd birthday!"
t('birthday', { year: 4 }); // → "It's your 4th birthday!"
t('birthday', { year: 21 }); // → "It's your 21st birthday!"
```

### Language-aware plurals

Pass `lang` to `<DocxEditor>` to enable correct plural rules via [`Intl.PluralRules`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/PluralRules):
