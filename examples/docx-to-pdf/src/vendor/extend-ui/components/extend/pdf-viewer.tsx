        ...
        <TooltipProvider>
          <ToolbarTooltip label="Pages sidebar">
            <Button
              ...
              className={cn(
                sidebarOpen && 'bg-accent text-accent-foreground ring-1 ring-ring/40 ring-inset'
              )}
              disabled={controlsDisabled}
        ...
        <div className="flex min-w-0 flex-wrap items-center justify-end gap-1">
          ...
          <div className="flex flex-none items-center gap-1">
            ...
            <Select
              ...
              disabled={controlsDisabled}
            >
              <SelectTrigger size="sm" className="w-[104px] min-w-[104px]" aria-label="Zoom level">
...
type InlineRegistryIconProps = Omit<React.ComponentProps<'svg'>, 'children' | 'strokeWidth'> & {
  strokeWidth?: number;
};
