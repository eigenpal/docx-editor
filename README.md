...
- **Internationalization (i18n)** — [`locale` prop](docs/i18n.md) for full UI translation, [community-contributed translations welcome](docs/i18n.md#contributing-a-new-locale)
