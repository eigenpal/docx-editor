...
Comment authors share the same colors, and the highlight over commented text carries `data-author`, `data-author-slot`, and `--doc-review-author` for styling it per reviewer.
