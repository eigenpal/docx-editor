...
2. Publish an implementation satisfying the stable entries, keeping retired entries resolvable as deprecated aliases.
...
- What is the deprecation window in practice for the retired entries, given no telemetry on who uses them?
