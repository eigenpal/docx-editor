...
- [x] 14.1b Match comment drafts to the configured author color, keep Vue slot measurement stable
      across card updates, and collapse resolved comments to a closed-rail-style empty comment
      icon with a green check in both adapters and closed-rail markers.
