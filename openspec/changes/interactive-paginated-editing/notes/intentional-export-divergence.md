...
- `DocxEditorMenuBar` — retired menu region (File / Format / Insert / Help), all items
  present and permanently disabled with a localized reason.
- `DocxEditorMenuBarProps` — its prop type.
