...
- [ ] 8.1 Replace the approved visible ProseMirror checkpoint with the engine-owned paginated paragraph surface without changing public support manifests.
- [ ] 8.2 Add a fixture covering known/unknown ordered OOXML, every D8 run/paragraph property, inline text, authored whitespace, tab, hard break, edits, and cross-page fragments.
- [ ] 8.3 Prove load, edit, format, semantic caret/selection, normalized save, namespace-aware fingerprint, semantic digest, and reopen through the private harness.
